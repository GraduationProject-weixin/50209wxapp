...
# 50209wxapp微信小程序投票评选系统的设计与实现ssm
...
此次开发这个微信小程序投票评选系统，不仅仅满足用户的需要，也能跟上时代的发展风向，从技术的角度还是用户的角度上进行开发都是很有意义的。
## 1.4 论文研究内容
...
|4|toupiaozhuti|String|投票主题|是|
|5|tupian|String|图片|是|
|6|piaoshu|Integer|票数|是|
|7|neirong|String|内容|是|
|8|faburiqi|date|发布日期|是|
|9|jiezhiriqi|date|截止日期|是|
...
|5|tupian|String|图片|是|
|6|piaoshu|Integer|票数|是|
|7|toupiaoshijian|datetime|投票时间|是|
